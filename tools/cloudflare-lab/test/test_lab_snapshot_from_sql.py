...
class ConverterTest(unittest.TestCase):
    def test_sql_backup_becomes_pos_snapshot(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(summary['included_entities'],['productos','clientes','creditos','creditos.pagos'])
            self.assertEqual(summary['zeroed_by_design'],['ventas','gastos','cajMovs','cashClosures','inventoryMovements'])
